...
var collistC = [
    {
    value: "C1_1",
    label: "C1_1、单位人才引进计划（不含应届高校毕业生）-本年度新引进人才数量",
    children: op_member
}, {
    value: "C1_2",
    label: "C1_2、单位人才引进计划（不含应届高校毕业生）-下年度预计引进人才数量",
    children: op_member
}, {
    value: "C1_3",
    label: "C1_3、单位高校应届毕业生引进计划-本年度新引进应届高校毕业生数量",
    children: op_member
}, {
    value: "C1_4",
    label: "C1_4、单位高校应届毕业生引进计划-目前引进高校毕业生人均工资水平（元/月）",
    children: op_money1
}, {
    value: "C1_5",
    label: "C1_5、单位高校应届毕业生引进计划-下年度预计引进应届毕业生数量",
    children: op_member
}, {
    value: "C2_1",
    label: "C2_1、单位人才招聘费用预算-本年度人才招聘费用预算（单位：元）",
    children: op_money2
}, {
    value: "C2_2",
    label: "C2_2、单位人才招聘费用预算-下年度人才招聘费用预算（单位：元）",
    children: op_money2
}, {
    value: "C2_3",
    label: "C2_3、单位人才培养费用预算-本年度人才培养费用预算（单位：元）",
    children: op_money2
}, {
    value: "C2_4",
    label: "C2_4、单位人才培养费用预算-下年度人才培养费用预算（单位：元）",
    children: op_money2
}, {
    value: 'C3',
