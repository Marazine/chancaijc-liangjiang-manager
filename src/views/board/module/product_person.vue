<template>
  <div class="back-img bh-50" :class="config.bh">
    <div class="title my-title-click" :style="{left:config.left?config.left:''}" v-if="config.isClick"
      @click="$router.push({name:'qyqk'})">
      <img src="../../../assets/img/arrow.png" alt="">
      {{config&&config.title?config.title:'标题'}}
    </div>
    <div class="title my-title" :style="{left:config.left?config.left:''}" v-else>
      <img src="../../../assets/img/arrow.png" alt="">
      {{config&&config.title?config.title:'标题'}}
    </div>
